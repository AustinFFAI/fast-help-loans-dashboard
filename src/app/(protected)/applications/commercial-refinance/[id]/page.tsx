...
export const metadata: Metadata = {
  title: "Commercial Refinance | Application Details",
};

const fetchApplication = createApplicationFetcher<CommercialRefinanceApi>(
  ApplicationTypeEndpoints.CommercialRefinance
);

export default async function CommercialRefinanceDetailPage({
  params,
}: PageProps) {
    ...
    <main className="w-full">
        ...
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href="/applications/commercial-refinance">
                Commercial Refinance
              </Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
        <div className="min-w-0">
          <div className="mb-2">
            <Link
              href="/applications/commercial-refinance"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent className="py-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <div className="text-xs text-muted-foreground">Refi Type</div>
                  <div className="text-sm font-medium">
                    {record.refinance_type ?? "-"}
                  </div>
                </div>
            ...
            <CardContent className="py-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="text-sm font-medium">
                    {String(record.mortgage_balance_1 ?? "-")}
                  </div>
                </div>
                <div>
                  <div className="text-xs text-muted-foreground">
                  ...
                  <div className="text-sm font-medium">
                    {String(record.monthly_payment_1 ?? "-")}
                  </div>
                </div>
                <div>
                  <div className="text-xs text-muted-foreground">
